...
var _shoppingCartJs = require("./shoppingCart.js"); // This process is more like creating an object during the importation process which we called shoppingCart. so before we use anything in the imported module, we have to attach the object to it.
...
(0, _shoppingCartJsDefault.default)('pizza', 2); // that function I made default export in the export module, I now called it add here and used it.
...
const getLastPost = async function() {
    ...
    return {
        ...
        text: data.at(-1).id
    }; // This will return a promise. remember that whatever returned within an async function will always be a promise.
};
...
console.log((0, _shoppingCartJs.cart).find((item)=>item.quantity >= 2));
Promise.resolve('Test').then((x)=>console.log(x)); // Because of Promises and some new ES6 codes, that Bable cannot convert to ES5, we need to download a new library to do that.
...
parcelHelpers.export(exports, "totalPrice", ()=>totalPrice) // Renameing the totalQuantity to tq
;
